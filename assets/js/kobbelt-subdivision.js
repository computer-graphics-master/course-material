define(['js/twgl','js/2d-boilerplate','js/sylvester','js/style','js/util','js/transformation-chain','js/camera','js/kobbelt-subdivision-mesh'],function(a,b,c,d,e,f,g,h){'use strict';const i=`attribute vec2 position;
